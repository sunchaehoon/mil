                                    ...
                                    <S.AlbumList>
                                       <S.RecommendTrackHome>
                                          <S.RecommendTrackList>
                                             ...
                                             {
                                                data.map(function(a: string | number, i: number): any {
                                                   return (
                                                      <li key={data[i].rank}>
                                                         <S.ThumbnailChart>
                                                            <img src={data[i].url} alt={`${data[i].artist} / ${data[i].url}`} className='chart_thumbnail' />
                                                            <S.ChartTitle>
                                                               {data[i].title}
                                                               <S.ChartArtist>{data[i].artist}</S.ChartArtist>
                                                            </S.ChartTitle>
                                                         </S.ThumbnailChart>
                                                      </li>
                                                   );
